...
**2. Reference sheets are single studio images.**
Each character reference sheet is a single image containing multiple panels — full-body views, face close-ups, expression studies, with color swatches and annotation lines. Not separate generations per angle. One generation per entity, with all the geometric and expressive information packed into the one image as a panel layout. Environment reference sheets are a single wide establishing shot — not a multi-panel composite — maximising spatial coverage of the full location.
...
GLOBAL ANCHOR: [Window / ceiling fixture / architectural feature] is the Global Anchor — its light-cast and position defines the scene.

ESTABLISHING WIDE SHOT: [Single viewpoint that captures the maximum spatial extent of the environment — the natural entry point or widest natural viewing angle, e.g. "standing in the doorway, camera facing the back wall, ultra-wide lens." The camera captures the full room in one frame: all walls, the ceiling edge, the flooring from near to far, and all Anchor Objects simultaneously visible.] Left third of frame: [describe exactly what's there]. Center third: [describe]. Right third: [describe]. Global Anchor visible. All Anchor Objects visible and in their mapped positions.
...
- **GLOBAL ANCHOR** — one light source or architectural feature that defines the scene
- **ESTABLISHING WIDE SHOT** — single ultra-wide viewpoint that fits the full room in one frame; all Anchor Objects visible simultaneously; left / center / right third of frame described
...
GLOBAL ANCHOR: The front window with gauze curtains (front-right corner) is the Global Anchor — its diffuse daylight wash falls left-to-right across the room.

ESTABLISHING WIDE SHOT: Standing just inside the front entrance at center, camera facing the back wall, ultra-wide lens capturing the full room floor-to-ceiling front-to-back in a single frame. Left third: left-wall shelving floor to ceiling, stepladder mid-left, shelves densely packed with candles, mugs, card displays, plush toys on the upper shelf. Center third: open grey wood-plank aisle receding to the back wall, ceiling pendant lamp above, handwritten paper sign hanging from the ceiling text-blurred; counter with brass cash register and low stool visible at the far end. Right third: right-wall shelving, front window with gauze curtains foreground-right with diffuse daylight falling diagonally left across the floor. All Anchor Objects simultaneously visible.
...
GLOBAL ANCHOR: The tall floor lamp beside the sofa (left of center) is the Global Anchor — its warm amber uplight is the dominant practical light source.

ESTABLISHING WIDE SHOT: Standing at the room entrance near the front door, camera facing the back wall, ultra-wide lens capturing the full living room floor-to-ceiling in a single frame. Left third: left-wall window with thin curtains mostly drawn, cool blue evening light diffuse through them, floor lamp standing in front of the sofa left end with warm amber shade visible. Center third: sage-green sofa against back wall, botanical print above it, cream throw draped over the right arm, cream area rug below, coffee table centered on the rug holding three stacked books, a ceramic mug, a white candle. Right third: right-wall shelving unit with trailing plants and blurred framed photographs, kitchen counter edge visible foreground-right with wooden cutting board. All Anchor Objects simultaneously visible, floor lamp amber uplight falling across sofa center.
